...
Implementation:
The Conways Game of Life code is implemented using Python and the GUI using Pygame.

Usage:

Mouse click to toggle the cell state. 
Press enter to produce the next generation
